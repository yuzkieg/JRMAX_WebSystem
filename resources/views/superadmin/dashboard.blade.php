                            ...
                            <td class="p-4 text-center flex justify-center gap-3">
                                <div class="relative inline-block">
                                    ...
                                    <div class="actions-menu hidden absolute right-0 mt-2 w-40 bg-[#262B32] rounded-lg shadow-xl z-50 border border-white/10" style="transform: translateZ(0); pointer-events: auto;">
                                        <button class="edit-btn edit-admin-btn flex items-center gap-3 w-full px-3 py-2 text-white hover:bg-white/5"
                                                data-id="{{ $admin->id }}"
                                        ...
                                        <button class="delete-btn delete-admin-btn flex items-center gap-3 w-full px-3 py-2 text-white hover:bg-white/5"
                                                data-id="{{ $admin->id }}"
                                                data-name="{{ $admin->name }}">
