...
<section id="home" class="relative w-full min-h-[750px] lg:min-h-[910px] overflow-hidden">
    ...
    <div class="relative z-10 flex flex-col items-center text-center text-white pt-28 space-y-6 max-w-4xl mx-auto px-6">
        ...
        <h1 class="text-red-600 text-[70px] sm:text-[90px] lg:text-[170px] font-black italic leading-[1]">
            JRMAX
        </h1>
        ...
        <div class="grid grid-cols-1 md:grid-cols-5 gap-6">
            ...
            <div class="flex items-end">
                <a href="/login" class="w-full">
                    <button class="w-full py-4 rounded-md bg-gradient-to-r from-red-700 to-red-500
...
{{-- SERVICES --}}
<section id="services" class="bg-[#1A1F24] text-white py-24">
    <h2 class="text-5xl text-center font-black mb-14">Services</h2>
    ...
    <div class="max-w-7xl mx-auto grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-10 px-6">
        ...
        <div class="group relative rounded-2xl overflow-hidden shadow-xl hover:scale-[1.03] transition">
            <img src="{{ asset('assets/'.$s['img']) }}" class="w-full h-[450px] object-cover">
...
<section id="requirements" class="bg-gray-100 py-24">
    <div class="max-w-4xl mx-auto px-6 text-center">
        <h2 class="text-5xl font-black mb-10">Requirements</h2>
        <ul class="space-y-4 text-gray-700 text-lg">
            <li>✔ Minimum age: 21 years old</li>
            <li>✔ Valid government-issued ID</li>
            <li>✔ Valid driver’s license (for self-drive)</li>
...
{{-- CONTACT --}}
<section id="contact" class="bg-gradient-to-r from-red-600 to-red-500 py-24" style="font-weight: bold;">
    <div class="max-w-4xl mx-auto px-6 text-center">
        <h2 class="text-5xl text-white mb-10">Contact Us</h2>
        <p class="text-white">Email: support@jrmax.com</p>
        <p class="text-white mt-2">Phone: +1 (800) 123-4567</p>
        <p class="text-white mt-2">Location: 1234 Main Street, City</p>
    </div>
</section>
